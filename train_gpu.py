...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'VisionMamba training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='vim_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_rope_also_residual',
                        type=str,
                        metavar='MODEL',
                        choices=['vim_base_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_rope_also_residual',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'VisionMamba training and evaluation script', parents=[get_args_parser()])
