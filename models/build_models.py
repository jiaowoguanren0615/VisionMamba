...
@register_model
def vim_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_rope_also_residual(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None,
                                                                                    **kwargs):
    model = VisionMamba(
...
@register_model
def vim_tiny_patch8_224_bimambav2_final_pool_mean_abs_pos_embed_rope_also_residual(pretrained=False,
...
@register_model
def vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_rope_also_residual(pretrained=False,
                                                                                     pretrained_cfg=None,
                                                                                     pretrained_cfg_overlay=None,
                                                                                     **kwargs):
    model = VisionMamba(
...
@register_model
def vim_base_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_rope_also_residual(pretrained=False,
                                                                                    pretrained_cfg=None,
                                                                                    pretrained_cfg_overlay=None,
                                                                                    **kwargs):
    model = VisionMamba(
...
#     net = vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_rope_also_residual(num_classes=5)
